...
public class SepararVocalesConsonantes {
	...
	static void crearFicheroTxt() {
		...
		int car=' ';
		try {
			FileWriter esc=new FileWriter("C:\\Users\\DA-1.PUESTO222\\Desktop\\ejercicios programación\\textos\\frase.txt");
	...
	static void crearFicheroVC() {
		...
		System.out.println("\n\tCREANDO FICHEROS...\n\t");
		try {
			FileReader lector=new FileReader("C:\\Users\\DA-1.PUESTO222\\Desktop\\ejercicios programación\\textos\\frase.txt");
			FileWriter escritorVocales= new FileWriter("C:\\Users\\DA-1.PUESTO222\\Desktop\\ejercicios programación\\textos\\vocales.txt");
			FileWriter escritorConsonantes=new FileWriter("C:\\Users\\DA-1.PUESTO222\\Desktop\\ejercicios programación\\textos\\conson.txt");
			car=lector.read();
			while(car!=-1) {
	...
	static void visualizarFicheros(int opcionFichero) {
		...
		case 3:
			try {
				...
				FileReader lectorFrase=new FileReader("E:\\CLASES\\PRG\\frase.txt");
		...
		case 4:
			...
			try {
				FileReader lectorVocales=new FileReader("E:\\CLASES\\PRG\\vocales.txt");
		...
		case 5:
			...
			try {
				FileReader lectorConsonantes=new FileReader("E:\\CLASES\\PRG\\consonant.txt");
