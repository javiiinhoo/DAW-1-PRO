...
public class Listas_02{
	...
	static void altas(Scanner e) throws IOException {
		String n=null;
		System.out.println("\n\tALTAS\n\t=====\n");
		DataOutputStream ficheroSal = new DataOutputStream(new FileOutputStream(ruta + "hominido.dat",true));			
	...
	static void lista() throws IOException{
		String n=null;
		boolean fin=false;
		DataInputStream ficheroEnt= new DataInputStream(new FileInputStream(ruta + "hominido.dat"));
		System.out.println("\n\tLISTADO\n\t=======\n\n\tNombre\n\t------\n");
	...
	static void ordenarFichero() throws IOException{
		...
		ordenarLista(l);
		ficheroEnt.close();
		DataOutputStream ficheroSal = new DataOutputStream(new FileOutputStream(ruta + "hominido.dat"));			
