...
public class FicheroBinBusquedaNumeros{
	...
	static int menu(Scanner e) {
		...
		System.out.println("4.Buscar número y las veces que se repite.");
	...
	static void crearFichero(Scanner e) {
		...
		try {
			...
			System.out.println("Teclear números (999 para finalizar:)");
			while(num!=999) {
				num= e.nextInt();
				salida.writeInt(num);
			}
	...
	static void buscarNumeroVeces() {
		...
		if(c!=0) 
			System.out.println("El número sí existe en el fichero y aparece "+c+" veces.");				
		else
			System.out.println("El número no existe en el fichero");	
	}
	static void fin() {
